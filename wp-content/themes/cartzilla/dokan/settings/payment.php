...
<div class="dokan-payment-settings-summary">
    ...
    <div class="payment-methods-listing-header">
        <h2 class="h3"> <?php esc_html_e( 'Payment Methods', 'cartzilla' ); ?></h2>
        <div>
            <div id="vendor-dashboard-payment-settings-toggle-dropdown">
                <a id="toggle-vendor-payment-method-drop-down" class="mb-3 d-block"> <?php esc_html_e( 'Add Payment Method', 'cartzilla' ); ?></a>
                    ...
                    <div id="vendor-payment-method-drop-down">
                                    ...
                                    <a href="<?php echo esc_url( dokan_get_navigation_url( 'settings/payment-manage-' . $method_key ) ); ?>">
                                        <div>
                                            ...
                                            <span>
                                                ...
                                                printf( esc_html__( 'Direct to %s', 'cartzilla' ), apply_filters( 'dokan_payment_method_title', $method['title'], $method ) );
                                                ?>
                                            </span>
                                        </div>
                                    </a>
                        ...
                        <?php else : ?>
                            <div class="no-content">
                                <?php esc_html_e( 'There is no payment method to add.', 'cartzilla' ); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="my-3">
                        <a href="<?php echo esc_url(  dokan_get_navigation_url( 'settings/payment-manage-' . $method_key . '-edit' ) ); ?>">
                            <button class="dokan-btn-theme dokan-btn-sm"><?php esc_html_e( 'Manage', 'cartzilla' ); ?></button>
                        </a>
                    </div>
                </div>
            </li>
    ...
    <?php else: ?>
        <div class="no-content">
            <?php esc_html_e( 'There is no payment method to show.', 'cartzilla' ); ?>
        </div>
    <?php endif; ?>
</div>
