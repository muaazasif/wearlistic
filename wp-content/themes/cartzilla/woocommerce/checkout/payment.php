...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="place-order border-top pt-4">
		<noscript>
			...
			?>
			<br/><button type="submit" class="button alt btn btn-sm btn-primary<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'cartzilla' ); ?>"><?php esc_html_e( 'Update totals', 'cartzilla' ); ?></button>
		</noscript>
