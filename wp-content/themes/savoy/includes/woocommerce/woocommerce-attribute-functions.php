    ...
    function nm_woocommerce_layered_nav_count( $term_html, $term, $link, $count ) {
        ...
        // Type: Image
            ...
            if ( $image_id ) {
                ...
                $custom_html = '<div class="nm-pa-image-thumbnail-wrap"><img src="' . esc_url( $image_url ) . '" alt="' . esc_attr( $image_alt ) . '" class="nm-pa-image-thumbnail"></div>';
            }
        }
                ...
                case 'image' :
                    ...
                    foreach ( $terms as $term ) {
                        if ( in_array( $term->slug, $options, true ) ) {
                            ...
                            $html .= '<li class="nm-variation-option'. $selected_class . '" data-value="' . esc_attr( $term->slug ) . '">';
                            $html .= '<div class="nm-pa-image-thumbnail-wrap"><img src="' . esc_url( $image_url ) . '" alt="' . esc_attr( $image_alt ) . '" class="nm-pa-image-thumbnail"></div>';
                            $html .= '<span>' . esc_html( apply_filters( 'woocommerce_variation_option_name', $term->name ) ) . '</span>';
                            $html .= '</li>';
                        }
                    }
