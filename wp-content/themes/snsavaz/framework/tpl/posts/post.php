    ...
    <div class="post-content">
        ...
        <div class="content">
            ...
            if (snsavaz_themeoption('show_date', 1) == 1 && !is_sticky()) : ?>
                <?php
                printf( '<span class="entry-date">%1$s<a href="%2$s" rel="bookmark"><time class="entry-date published" datetime="%2$s">%3$s</time></a></span>',
                esc_html('Date: ', 'snsavaz'),
