...
<ul class="socials">
	<?php if($snsavaz_obj->snsavaz_getOption('show_facebook_sharebox')==1): ?>
	<li class="facebook">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_twitter_sharebox')==1): ?>
	<li class="twitter">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_linkedin_sharebox')==1): ?>
	<li class="linkedin">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_tumblr_sharebox')==1): ?>
	<li class="tumblr">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_gplus_sharebox')==1): ?>
	<li class="google">
...
'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_pinterest_sharebox')==1): ?>
	<li class="pinterest">
	...
	<?php endif; ?>
	<?php if($snsavaz_obj->snsavaz_getOption('show_email_sharebox')==1): ?>
	<li class="email">
