...
global $post, $snsavaz_opt, $snsavaz_blog_pagination;
$snsavaz_blog_pagination = $pagination;
...
if( have_posts() ) :
	snsavaz_set_themeoption('blog_class', ' sns-blog-page '.$extra_class);
	snsavaz_set_themeoption('blog_type', $blog_type);
	snsavaz_set_themeoption('excerpt_length', $excerpt_length);
	snsavaz_set_themeoption('show_readmore', $show_readmore);
	snsavaz_set_themeoption('pagination', $pagination);
	ob_start();
	?>
